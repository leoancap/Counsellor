...
export const generateProfessionals = (
  ...
  },
  {
    ...
    summary:
      "was a Swiss psychiatrist and psychoanalyst who founded analytical psychology. Jung's work was influential in the complaints of psychiatry, anthropology, archaeology, literature, philosophy, and religious studies. Jung worked as a research scientist at the famous Burghölzli hospital, under Eugen Bleuler. During this time, he came to the attention of Sigmund Freud, the founder of psychoanalysis. The two men conducted a lengthy correspondence and collaborated, for a while, on a joint vision of human psychology.",
    reviews: [5, 4, 4, 3, 3],
    ratesPerHour: 160,
    availabilitySlots: generateRosterInterval(startDate, endDate),
  },
